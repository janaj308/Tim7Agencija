...
@FacesConverter("destForPhotoConverter")
public class DestForPhotoConverter implements Converter {
	@Override
	public Object getAsObject(FacesContext context, UIComponent component, String id) {
		
		PostPhotoManagedBean data = context.getApplication().evaluateExpressionGet(context, "#{postPhotoManagedBean}", PostPhotoManagedBean.class);
